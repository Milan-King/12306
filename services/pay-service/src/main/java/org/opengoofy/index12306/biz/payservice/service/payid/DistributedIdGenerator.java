 ...
 * 全局唯一支付流水号生成器（雪花算法变种）
 * 算法参数：
 * - EPOCH：2021-01-01 00:00:00 UTC（1609459200000L）
 * - NODE_BITS：5 位，最多 32 个节点
 * - SEQUENCE_BITS：7 位，每毫秒最多 128 个 ID
...
public class DistributedIdGenerator {
    ...
    /** 节点 ID 位数：5位，支持 0-31 共 32 个节点 */
    private static final int NODE_BITS = 5;
    /** 序列号位数：7位，每毫秒最多 128 个 ID */
